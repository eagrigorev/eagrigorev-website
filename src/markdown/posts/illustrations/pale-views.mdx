...
<EmbedImage
  src="posts/pale-views/pale-views-008.jpg"
  alt="Pale Views VIII"
  caption="Pale Views VIII"
  layout="right"
/>

Palettes:
[Japanese Woodblock](https://lospec.com/palette-list/japanese-woodblock) by
[Polyducks](https://polyducks.co.uk/) (pictures I — VII) and
[Waldgeist](https://lospec.com/palette-list/waldgeist) by
[AcidBurritos](https://www.gamedevmarket.net/member/AcidBurritos) (picture
VIII).
